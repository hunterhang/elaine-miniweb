    ...
    <!--
        <li class="nav-item header-item">
            ...
            <router-link tag="div" to='/' style="height:55px;" class="nav-link">
                ...
                <p style="color:white"> 商品管理 </p>
            </router-link>
        </li>
        
        <li class="nav-item header-item">

            <router-link tag="div" to='/sys_config' style="height:55px;" class="nav-link">
                <p>
                    <Icon type="stats-bars" size='30' color="#2d8cf0"></Icon>
                </p>
                <p style="color:white">系统配置</p>
            </router-link>
    ...
    <ul class="nav navbar-nav ml-auto">
        ...
        <!--
            <li class="nav-item d-md-down-none">
                <a class="nav-link">
                    <Icon type="android-notifications" size="20"></Icon><span class="badge badge-pill badge-danger">5</span></a>
            </li>
        -->
