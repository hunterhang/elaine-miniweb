...
class WxpayService
{
  ...
  protected $key;
  protected $nonce_str;
  public function __construct($mchid, $appid, $key,$pay_key)
  {
...
//    print_r($config);
    ...
    $unified['sign'] = self::getSign($unified,$config['pay_key']);
 //   print_r($unified);
    ...
    */
    ...
    error_log($openid."|".$totalFee."|".$outTradeNo."|".$timestamp."|".var_export($unifiedOrder,true));
  ...
  public function notify()
  {
    ...
    */
    ...
    $arr = (array)$postObj;
    unset($arr['sign']);
    if (self::getSign($arr, $config['pay_key']) == $postObj->sign) {
